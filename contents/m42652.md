...
<span data-type="alternates" id="Phet_module_32.2" data-alt=""> [![](../resources/PhET_Icon.png){: data-print="false"}](alpha-decay_en.jar){: data-type="image-with-thumbnail"} ![](../resources/PhET_Icon.png){: data-print="true"} </span>
</figure>
</div>
