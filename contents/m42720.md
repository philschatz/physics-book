...
<table id="import-auto-id1125517" summary="Four-column table of submicroscopic masses. Column one lists the symbol. Column two lists its meaning. Column three lists its best value, and column four lists its approximate value."><caption><span data-type="title">Submicroscopic Masses<sup><a data-type="footnote-number" name="footnote-ref2" href="#footnote2"><sup>2</sup></a></sup></span></caption><thead>
          <tr>
            <th>Symbol</th>
            <th>Meaning</th>
            <th>Best Value</th>
...
1.  [1](#footnote-ref1){: data-type="footnote-ref" name="footnote1"} Stated values are according to the National Institute of Standards and Technology Reference on Constants, Units, and Uncertainty, [www.physics.nist.gov/cuu][1] (accessed May 18, 2012). Values in parentheses are the uncertainties in the last digits. Numbers without uncertainties are exact as defined.
2.  [2](#footnote-ref2){: data-type="footnote-ref" name="footnote2"} Stated values are according to the National Institute of Standards and Technology Reference on Constants, Units, and Uncertainty, [www.physics.nist.gov/cuu][1] (accessed May 18, 2012). Values in parentheses are the uncertainties in the last digits. Numbers without uncertainties are exact as defined.

</div>



[1]: http://www.physics.nist.gov/cuu
