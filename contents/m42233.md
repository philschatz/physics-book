...
<div data-type="alternates" id="Phet_module_16.2" data-alt="">
[![](../resources/PhET_Icon.png){: data-print="false"}](states-of-matter_en.jar){: data-type="image-with-thumbnail"} ![](../resources/PhET_Icon.png){: data-print="true"}
</div>
</figure>
</div>
