...
<div data-type="alternates" id="Phet_module_25.2" data-alt="">
[![](../resources/PhET_Icon.png){: data-print="false"}](radio-waves_en.jar){: data-type="image-with-thumbnail"} ![](../resources/PhET_Icon.png){: data-print="true"}
</div>
</figure>
</div>
