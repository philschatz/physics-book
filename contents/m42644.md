...
<div data-type="alternates" id="Phet_module_32.7" data-alt="">
[![](../resources/PhET_Icon.png){: data-print="false"}](quantum-tunneling_en.jar){: data-type="image-with-thumbnail"} ![](../resources/PhET_Icon.png){: data-print="true"}
</div>
</figure>
</div>
