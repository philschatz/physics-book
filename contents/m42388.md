...
<div data-type="alternates" id="Phet_module_2.7" data-alt="">
[![](../resources/PhET_Icon.png){: data-print="false"}](magnet-and-compass_en.jar){: data-type="image-with-thumbnail"} ![](../resources/PhET_Icon.png){: data-print="true"}
</div>
</figure>
</div>
