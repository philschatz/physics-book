...
<div data-type="note" data-has-label="true" id="eip-494" data-label="" markdown="1">
<div data-type="title">
...
<div data-type="alternates" id="Phet_module_18.1" data-alt="Make waves with a dripping faucet, audio speaker, or laser! Add a second source or a pair of slits to create an interference pattern.">
[![Make waves with a dripping faucet, audio speaker, or laser! Add a second source or a pair of slits to create an interference pattern.](../resources/PhET_Icon.png){: data-print="false"}](wave-interference_en.jar){: data-type="image-with-thumbnail"} ![Make waves with a dripping faucet, audio speaker, or laser! Add a second source or a pair of slits to create an interference pattern.](../resources/PhET_Icon.png){: data-print="true"}
</div>
</figure>
</div>
