...
<div data-type="note" id="eip-835" data-label="" markdown="1">
<div data-type="title">
...
<span data-type="media" id="Phet_module_24.7" data-alt=""> [![](../resources/PhET_Icon.png)](generator_en.jar){: data-type="image"} <span data-media-type="image/png" data-print="true" data-src="PhET_Icon.png" data-type="image" width="450" /> </span>
</figure>
</div>
