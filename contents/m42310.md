...
<div data-type="alternates" id="Phet_module_19.4" data-alt="">
[![](../resources/PhET_Icon.png){: data-print="false"}](efield_en.jar){: data-type="image-with-thumbnail"} ![](../resources/PhET_Icon.png){: data-print="true"}
</div>
</figure>
</div>
