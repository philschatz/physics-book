...
2.  {: #import-auto-id1502054} A ray entering a diverging lens parallel to its axis seems to come from the focal point F.
...
4.  {: #import-auto-id2543718} A ray entering a converging lens through its focal point exits parallel to its axis.
5.  {: #import-auto-id1611116} A ray that enters a diverging lens by heading toward the focal point on the opposite side exits parallel to the axis.
{: data-number-style="arabic"}
