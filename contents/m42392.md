...
<div data-type="alternates" id="Phet_module_24.2" data-alt="">
[![](../resources/PhET_Icon.png){: data-print="false"}](faraday_en.jar){: data-type="image-with-thumbnail"} ![](../resources/PhET_Icon.png){: data-print="true"}
</div>
</figure>
</div>
