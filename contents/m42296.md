...
<div data-type="alternates" id="Phet_module_18.5" data-alt="">
[![](../resources/PhET_Icon.png){: data-print="false"}](sound_en.jar){: data-type="image-with-thumbnail"} ![](../resources/PhET_Icon.png){: data-print="true"}
</div>
</figure>
</div>
