...
<div data-type="alternates" id="Phet_module_21.3" data-alt="">
[![](../resources/PhET_Icon.png){: data-print="false"}](resistance-in-a-wire_en.jar){: data-type="image-with-thumbnail"} ![](../resources/PhET_Icon.png){: data-print="true"}
</div>
</figure>
</div>
